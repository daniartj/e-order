...
self.addEventListener('fetch', (event) => {
  ...
  if (!url.pathname.startsWith('/kasir/') && !url.pathname.startsWith('/static/')) return;
...
self.addEventListener('notificationclick', (event) => {
  ...
  const url = (event.notification.data && event.notification.data.url) ? event.notification.data.url : '/kasir/dashboard/';
